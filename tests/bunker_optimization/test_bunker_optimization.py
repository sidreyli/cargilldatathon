"""Test script for bunker port optimization."""
...
# Test OCEAN HORIZON (MAP TA PHUT) -> CSN (ITAGUAI -> QINGDAO)
# This should prefer Gibraltar bunker port (cheapest VLSFO at 474)
vessel = vessels[1]  # OCEAN HORIZON
cargo = cargoes[2]   # CSN Iron Ore (Brazil-China)
...
if result.selected_bunker_port:
    ...
    print(f"  Detour: {(result.ballast_leg_to_bunker + result.bunker_to_load_leg) - result.direct_ballast_distance:.0f} nm")
